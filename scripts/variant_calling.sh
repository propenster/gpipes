...
# download data
wget -P ~/Users/propenster/gpipes/reads ftp://ftp-trace.ncbi.nih.gov/1000genomes/ftp/phase3/data/HG00096/sequence_read/SRR062634_1.filt.fastq.gz
wget -P ~/Users/propenster/gpipes/reads ftp://ftp-trace.ncbi.nih.gov/1000genomes/ftp/phase3/data/HG00096/sequence_read/SRR062634_2.filt.fastq.gz



echo "Run Prep files..."

################################################### Prep files (TO BE GENERATED ONLY ONCE in your bio workflow lifetime or semester! Lol!) ##########################################################



# download reference files
wget -P ~/Users/propenster/bio/supporting_files/hg38/ https://hgdownload.soe.ucsc.edu/goldenPath/hg38/bigZips/hg38.fa.gz
gunzip ~/Users/propenster/bio/supporting_files/hg38/hg38.fa.gz

# index ref - .fai file before running haplotype caller
samtools faidx ~/Users/propenster/bio/supporting_files/hg38/hg38.fa


# ref dict - .dict file before running haplotype caller
gatk CreateSequenceDictionary R=~/Users/propenster/bio/supporting_files/hg38/hg38.fa O=~/Users/propenster/bio/supporting_files/hg38/hg38.dict


# download known sites files for BQSR from GATK resource bundle
# get base quality score ref file
wget -P ~/Users/propenster/bio/supporting_files/hg38/ https://storage.googleapis.com/genomics-public-data/resources/broad/hg38/v0/Homo_sapiens_assembly38.dbsnp138.vcf
wget -P ~/Users/propenster/bio/supporting_files/hg38/ https://storage.googleapis.com/genomics-public-data/resources/broad/hg38/v0/Homo_sapiens_assembly38.dbsnp138.vcf.idx
...
# directories
ref="~/Users/propenster/bio/supporting_files/hg38/hg38.fa"
known_sites="~/Users/propenster/bio/supporting_files/hg38/Homo_sapiens_assembly38.dbsnp138.vcf"
aligned_reads="~/Users/propenster/gpipes/aligned_reads"
reads="~/Users/propenster/gpipes/reads"
results="~/Users/propenster/gpipes/results"
data="~/Users/propenster/gpipes/data"
